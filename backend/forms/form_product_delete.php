...
<main>
    <form class="call-form" action="../db/db_product_delete.php" method="POST">
        <?php
        ...
        <p class="input-id">
            ...
            <input type="number" id="product_price" name="product_price" value="<?php echo $product_price; ?>" readonly>
        </p>
        <div>
            <p class="buttons">
