...
if ($result) {
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '<main class="bg-green flex flex-col gap-6 p-3" style="flex: 1;">
                <div class="border rounded-2xl p-3 flex flex-col items-center gap-6">
        ...
        echo
                '<div class="flex items-center gap-6">
                    ...
                    <p class="button"><a href="/student014/shop/backend/db/db_order_insert.php">Return to Start</a></p>
                </div>
                </div>
            </main>';
    }
